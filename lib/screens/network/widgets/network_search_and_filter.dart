...
enum NetworkScreenConnectionType {
  myConnections,
  suggestions,
  requests,
}
...
class NetworkSearchAndFilter extends StatefulWidget {
  ...
  final void Function(NetworkScreenConnectionType)? onChangedConnectionState;
...
class _NetworkSearchAndFilterState extends State<NetworkSearchAndFilter> {
  List<NetworkScreenConnectionType> networkTypes = [
    NetworkScreenConnectionType.myConnections,
    NetworkScreenConnectionType.suggestions,
    NetworkScreenConnectionType.requests,
  ];

  NetworkScreenConnectionType selectedNetworkType =
      NetworkScreenConnectionType.myConnections;
