...
class NetworkTabScreen extends StatefulWidget {
  const NetworkTabScreen({super.key});

  @override
  State<NetworkTabScreen> createState() => _NetworkTabScreenState();
}

class _NetworkTabScreenState extends State<NetworkTabScreen> {
  int _currentIndex = 2;
