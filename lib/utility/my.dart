...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TooltipOverlayScreen(),
    );
  }
}
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    // Editable TextField with transparent background
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        fillColor: Colors.black
                            .withOpacity(0.3), // TextField background
                    ...
                    Align(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          setState(() {
                            showTooltip = false; // Close tooltip after updating
                          });
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content:
                                  Text('Updated text: ${textController.text}'),
                            ),
                          );
                        },
